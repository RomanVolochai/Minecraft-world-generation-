...
def main():
    ...
    parser.add_argument("--compare", type=str, choices=["baseline", "naive_bayes", "mrf", "gmm", "gan"], required=True, help="Comma separated list of models to evaluate (e.g. baseline,naive_bayes)")
