...
class NaiveBayesModel:
    ...
    def save(self, path):
        ...
        print(f"NaiveBayesModel saved to {path}")

    def load(self, path):
        state = joblib.load(path)
        self.prior = state['prior']
        self.cond = state['cond']
        self.log_prior = state['log_prior']
        self.log_cond = state['log_cond']
        print(f"NaiveBayesModel loaded from {path}")
